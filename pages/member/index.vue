    ...
    <div class="content">
        ...
        <div class="search">
            <div class="q-gutter-md row items-start">
                <q-input outlined v-model="searchParam.mberId" label="회원아이디" round dense flat class="input"/>
                <q-input outlined v-model="searchParam.mberNm" label="회원명" round dense flat class="input"/>
        ...
        <div class="proc">
          <q-btn push class="button" color="primary" label="회원권한등록" @click="clickMberAuthorAdd" />
        </div>
    </div>
      ...
      <q-dialog v-model="showAuthorMapngDialog">
        <q-layout container style="width: 800px; max-width: 100vw;">
          ...
          <q-page-container class="bg-white">
            <q-card>
              <q-card-section>
                <q-input v-model="AuthorParam.mberId" label="회원아이디" class="input" outlined :readonly="true" />
                <q-table :rows="resAuthorData" row-key="authorId" :columns="AuthorColumns"
              ...
              <q-toolbar class="bg-white">
                ...
                <div class="q-gutter-md row items-start">
                  <q-btn push color="primary" label="등록" type="submit" @click="addAuthorMapng" />
                  <q-btn push color="primary" label="삭제" type="submit" @click="removeAuthorMapng" />
                </div>
              </q-toolbar>
            </q-card>
          </q-page-container>
...
const AuthorColumns = ref<QTableProps["columns"]>([
    { name: 'authorId', align: 'center', label: '권한ID', field: 'authorId', sortable: false },
    { name: 'authorNm', align: 'center', label: '권한명', field: 'authorNm', sortable: false },
    { name: 'mberAuthorAddAt', align: 'center', label: '권한등록여부', field: 'mberAuthorAddAt', sortable: false }
])
